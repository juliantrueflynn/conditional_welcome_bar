...
module ShopifyApp
  module EnsureLoggedIn
    ...
    def has_shopify_session?
      return false if session[:shopify].blank?
    ...
    def redirect_to_login
      if request.xhr?
        ...
        if request.get?
          session[:return_to] = "/?#{sanitized_params.to_query}"
        end
    ...
    def fullpage_redirect_to(url)
      render 'shopify_app/shared/redirect',
        layout: false,
